...
const Features = () => {
    return (
        <section className="pt-16 md:pt-24">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-linear-to-r from-[#04BCD4]/5 to-[#54AC5C]/5 rounded-full blur-3xl" />
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {features.map((feature, index) => (
                        <Card
                            key={feature.title}
                            className="group border-2 border-transparent hover:border-[#04BCD4] transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 animate-fade-in bg-white"
                        ...
                        >
                            ...
                            {/* Hover linear Effect */}
                            <div className="absolute inset-0 bg-linear-to-br from-[#04BCD4]/0 to-[#54AC5C]/0 group-hover:from-[#04BCD4]/5 group-hover:to-[#54AC5C]/5 transition-all duration-500 pointer-events-none rounded-lg" />
                        </Card>
                    ))}
                </div>
            </div>
