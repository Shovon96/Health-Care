            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-12 gap-4">
                    <div className="space-y-3">
                        <h2 className="text-3xl md:text-4xl font-bold text-[#07824a] uppercase">
                    ...
                    <a 
                        href="#" 
                        className="group flex items-center gap-2 text-[#04BCD4] text-base md:text-lg font-semibold hover:gap-3 transition-all duration-300 uppercase"
                    >
                        View All
                    ...
                    {specialists.map((specialist, index) => (
                        <Card
                            ...
                            className={cn(
                                ...
                                'hover:border-[#04BCD4] hover:shadow-2xl hover:-translate-y-2',
                                'animate-fade-in'
                            )}
                        ...
                        >
                            <CardContent className="p-8">
                                ...
                                >
                                    <specialist.icon
                                        className={cn(specialist.iconColor, 'transition-colors duration-500 group-hover:text-white')}
                                        size={40}
                                    />
                                </div>
                                
                                {/* Specialty Name */}
                                <h3 className="text-xl font-bold text-[#07824a] mb-2 group-hover:text-[#04BCD4] transition-colors duration-300">
                                    {specialist.name}
                                </h3>
