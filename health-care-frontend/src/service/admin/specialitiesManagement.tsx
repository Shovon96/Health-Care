...
import { createSpecialityZodSchema, updateSpecialityZodSchema } from "@/src/zodValidators/specialities.validation";
...
export async function createSpeciality(_prevState: any, formData: FormData) {
    try {
        ...
        const validatedPayload = zodValidation(validationPayload, createSpecialityZodSchema);
...
export async function updateSpeciality(id: string, _prevState: any, formData: FormData) {
    try {
        ...
        const validatedPayload = zodValidation(validationPayload, updateSpecialityZodSchema);
